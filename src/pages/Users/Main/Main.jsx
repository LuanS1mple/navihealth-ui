    ...
    <>
      <Box sx={{
        ...
        <Box>
          ...
          <Box>
            <Box component="main" sx={{ flexGrow: 1, width: `calc(100vw - 250px - 50px)` }}>
              {/* Page Content */}
              <Box sx={{ p: 3 }}>
                {/* Quick Info Section */}
                <Box sx={{ mb: 4 }}>
                  ...
                  <Grid container spacing={2}>
                    {healthStats.map((stat, index) => (
                      <Grid item xs={12} sm={6} md={3} key={index}>
                        <Card
                          sx={{
                            width: `calc((100vw - 250px - 50px)/4 - 32px)`,
                            borderRadius: '16px',
                ...
                <Grid sx={{display: 'flex',justifyContent:'space-around', gap: 2}} >
                  ...
                  <Grid sx={{width: `calc(100%/2 - 16px)`}} item xs={12} md={6}>
                    <Card
                      sx={{
                        borderRadius: '16px',
                        boxShadow: '0px 4px 6px -1px rgba(0,0,0,0.1), 0px 2px 4px -2px rgba(0,0,0,0.1)',
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  <Grid sx={{display: 'flex', justifyContent: 'space-around'}} spacing={3}>
                    <Grid sx={{width: `calc(100%/2 - 16px)` }} item xs={12} md={6}>
                      <Card
                        sx={{
                          borderRadius: '16px',
